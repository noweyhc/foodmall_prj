		...
		<div id="product-list" align="center">
			...
			<div class="row row-cols-4">
				<c:forEach var="p" items="${list }">
					<ul class="items">
						<li class="item-image"><a
							href="/detailProducts.do?no=${p.product_no }"><img
								src="img/${p.product_main_img}" width="250" height="250"></a></li>
						<li class="title"><a
							href="/detailProducts.do?no=${p.product_no }" class="a">${p.product_title }</a></li>
						<li class="subtitle">${p.product_subtitle }</li>
						<li class="price"><fmt:formatNumber
								value="${p.product_price }" pattern="#,###" />원</li>
					</ul>
				</c:forEach>
			</div>
