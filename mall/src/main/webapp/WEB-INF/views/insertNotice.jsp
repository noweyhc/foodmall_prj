				...
				<div class="row">
					<div class="input-field col s2">
						<i class="material-icons prefix">account_box</i> <input
							id="notice_manager" name="notice_manager" type="text"
							class="validate"> <label for="notice_manager">작성자</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="input-field col s5">
						<i class="material-icons prefix">title</i> <input
							id="notice_title" name="notice_title" type="text"
							class="validate"> <label for="notice_title">글제목</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="input-field col s10">
						...
						<textarea id="icon_prefix2" rows="30" class="materialize-textarea"
							name="notice_content" placeholder="내용을 입력해 주세요."></textarea>
